...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_death_initially(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)

        date_of_death_init = datetime.date(2023, 11, 11)
        self.assertEqual(response.context['form'].initial['date_of_death'], date_of_death_init)

    def test_redirects_to_author_on_success(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
